...
if (isset($_POST['add_to_cart'])) {
    ...
    if (mysqli_num_rows($check_cart_numbers) > 0) {
        ...
        mysqli_query($conn, "INSERT INTO `cart`(user_id, name, price, quantity, image) VALUES('$user_id', '$product_name', '$product_price_idr', '$product_quantity', '$product_image')") or die('query failed');
...
<section class="home-contact">
   ...
   <div class="content">
      <h3>Yen sampeyan duwe pitakonan 👇</h3>
      <p></p>
